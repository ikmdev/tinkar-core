...
public class ElkSnomedDataBuilder {
	...
	public void build() throws Exception {
		...
		if (progressUpdater != null)
			progressUpdater.updateMessage(String.format("Total axioms: %,d", totalCount));
		...
		if (progressUpdater != null)
			progressUpdater.updateMessage(String.format("Total processed: %,d Active concepts: %,d ", processedCount.get(), data.getActiveConceptCount()));
