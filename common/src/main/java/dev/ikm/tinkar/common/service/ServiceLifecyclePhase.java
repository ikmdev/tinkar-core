 ...
 * <p>Services start in the order defined by this enum (top to bottom),
 ...
 * <p>Modeled after Maven's build lifecycle phases, this provides a
 * clear contract for service initialization order.
 * <p>Services within the same phase may start in any order unless a
 * sub-priority is specified. Sub-priorities are integers from 0-99,
 * with lower values starting first.
 *
 * <p><b>Command-Line Overrides</b></p>
 * <p>Service phases and sub-priorities can be overridden via system properties:
 * <ul>
 ...
 * </ul>
 * <p>Use the simple class name (without package) for the property.
 */
public enum ServiceLifecyclePhase {

    /**
     * Infrastructure phase - executors, thread pools, core utilities.
     * <p>     * Examples: ExecutorProvider, logging configuration, monitoring
     * <p>Base value: 0</p>
     */
    INFRASTRUCTURE(0),
     ...
     * <p>     * This phase allows for interactive or programmatic configuration after
     ...
     * <p>     * Examples: Configuration UI, provider selection dialogs, settings managers
     * <p>Base value: 100</p>
     */
    CONFIGURATION(100),
     ...
     * <p>     * Services that provide access to entities, public IDs, descriptions, and stamps.
     * These services depend on data storage but are needed before indexing.
     * <p>     * Examples: EntityService, PublicIdService, StampService, DefaultDescriptionForNidService
     * <p>Base value: 300</p>
     */
    ENTITIES(300),
     ...
     * <p>     * Examples: Lucene indexer, cache managers
     * <p>Base value: 400</p>
     */
    INDEXING(400),
     ...
     * <p>     * This phase occurs after all data infrastructure (storage, entities, indexing)
     ...
     * <p>     * Examples: StampService, ConceptService, EntityService
     * <p>Base value: 600</p>
     */
    CORE_SERVICES(600),
     ...
     * <p>     * Examples: ReasonerService, ClassifierService
     * <p>Base value: 700</p>
     */
     ...
     * <p>     * Examples: UI controllers, window managers, event dispatchers
     * <p>Base value: 800</p>
     */
    PRESENTATION(800);
     ...
     * <p>     * This value is used internally for ordering. Services can specify
