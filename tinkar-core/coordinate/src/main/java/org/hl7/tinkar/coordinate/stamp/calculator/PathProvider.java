...
public class PathProvider {
    ...
    private static final ConcurrentHashMap<Integer, ImmutableSet<StampPositionRecord>> SINGLETONS =
    ...
    public static ImmutableSet<StampPositionRecord> getPathOrigins(int pathNid) {
