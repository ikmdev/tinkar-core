...
public class TinkarTerm {
    ...
    public static final EntityProxy.Pattern EL_PLUS_PLUS_INFERRED_FORM_ASSEMBLAGE =
            EntityProxy.Pattern.make("EL++ inferred form assemblage (SOLOR)", UUID.fromString("1f20182c-960e-11e5-8994-feff819cdc9f"));
    ...
    public static final EntityProxy.Pattern EL_PLUS_PLUS_STATED_FORM_ASSEMBLAGE =
            EntityProxy.Pattern.make("EL++ stated form assemblage (SOLOR)", UUID.fromString("1f201994-960e-11e5-8994-feff819cdc9f"));
