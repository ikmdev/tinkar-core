    ...
    public String getMessage() {
        ...
        switch (errorType) {
            case UNEXPECTED_CHAR:
                sb.append("Unexpected character (").append(unexpectedObjectString).append(") at position ").append(position).append(".");
                break;
            case UNEXPECTED_TOKEN:
                sb.append("Unexpected token ").append(unexpectedObjectString).append(" at position ").append(position).append(".");
                break;
            case UNEXPECTED_EXCEPTION:
                sb.append("Unexpected exception at position ").append(position).append(": ").append(unexpectedObjectString);
                break;
            default:
                throw new UnsupportedOperationException(sb.append("Unkown error at position ").append(position).append(".").toString());
        }
        return sb.toString();
    }
}