        ...
        implements ConcurrentMutableMap<UUID, Integer>, Externalizable
{
    ...
    public void read(DataInput dataInput) throws IOException {
        ...
        {
            this.put(new UUID(dataInput.readLong(), dataInput.readLong()), dataInput.readInt());
        }
    }
    ...
    public void write(DataOutput dataOutput) throws IOException {
        ...
        for (int i = 0; i < this.table.length() - 1; i++)
        {
            ...
            {
                count++;
                dataOutput.writeLong(e.key_msb);
                dataOutput.writeLong(e.key_lsb);
                dataOutput.writeInt(e.value);
                e = e.getNext();
            }
        }
        if (count != size)
