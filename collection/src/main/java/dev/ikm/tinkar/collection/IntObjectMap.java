...
public interface IntObjectMap<E>
{
	 ...
	 * is replaced by the specified value. (A map {@code m} is said to contain
	 * a mapping for a key {@code k} if and only if
	 * {@link #containsKey(int) m.containsKey(k)} would return {@code true}.)
	 *
	 * @param key key with which the specified value is to be associated
	 * @param value value to be associated with the specified key
         * @return {@code true} if the receiver did not already contain such a key; {@code false} if the receiver did
   *         already contain such a key - the new value has now replaced the formerly associated value.
	 ...
	 * if {@link #containsKey(int) m.containsKey(k)} would return {@code true}.)
	 *
	 * @param key key with which the specified value is to be associated
	 * @param value value to be associated with the specified key
