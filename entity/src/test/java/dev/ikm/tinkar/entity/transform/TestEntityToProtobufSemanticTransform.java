...
public class TestEntityToProtobufSemanticTransform {
    ...
    public void semanticChronologyTransformWithZeroVersion() {
        // Given an Entity Semantic Version with zero versions
        ...
        assertThrows(Throwable.class, () -> EntityToTinkarSchemaTransformer.getInstance()
                .createPBSemanticVersions(RecordListBuilder.make().build()), "Not allowed to have an empty Semantic Version.");
    }
}
