...
public class TestEntityToProtobufPatternTransform {
    ...
    public void patternVersionTransformWithZeroVersion() {
        // Given an Entity Pattern Version with zero versions
        // When we transform our Entity Pattern Version into a PBPatternVersion
        // Then the resulting PBPatternVersion should throw
        assertThrows(Throwable.class, () -> EntityToTinkarSchemaTransformer.getInstance()
                .createPBPatternVersions(RecordListBuilder.make().build()), "Not allowed to have an empty Pattern Version.");
    }
}
