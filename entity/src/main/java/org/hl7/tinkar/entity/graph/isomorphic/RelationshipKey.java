...
import static org.hl7.tinkar.entity.graph.isomorphic.IsomorphicResultsLeafHash.makeNidListHash;
...
public class RelationshipKey
    ...
    public RelationshipKey(int vertexIndex, DiTreeEntity expression) {
        ...
        this.hashCode = Objects.hash(necessarySet,
                makeNidListHash(expression.vertex(vertexIndex).getMeaningNid(),
