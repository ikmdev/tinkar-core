...
STAMP coordinates control *temporal versioning* and *provenance tracking* in Tinkar. STAMP is an acronym for:
...
Every version of every entity in Tinkar carries STAMP metadata. STAMP coordinates specify which versions you want to see.
