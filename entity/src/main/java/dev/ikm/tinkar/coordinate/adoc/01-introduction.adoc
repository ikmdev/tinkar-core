...
In Tinkar, a *coordinate* is a specification that describes *how* to access and interpret knowledge at a specific point in time, in a specific language, using specific reasoning rules, and through a specific navigational structure.
